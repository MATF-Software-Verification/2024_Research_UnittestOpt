...
class ProjectLoader(CustomComponent):
    ...
    def select_project(self):
        ...
        self.loading_progressbar.grid(row=0, column=2, sticky='we', padx=25)
    ...
    def load_project(self):
        ...
        self.loading_label.grid(row=0, column=2, sticky='we', padx=25)
    ...
    def pack_elements(self, root: customtkinter.CTk):
        ...
        select_project_button.grid(row=0, column=0, sticky='we', padx=25)

        selected_project_label = customtkinter.CTkLabel(self.frame, textvariable=self.selected_project_variable)
        selected_project_label.grid(row=0, column=1, sticky='we', padx=25)
